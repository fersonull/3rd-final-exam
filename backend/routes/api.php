...
Router::get('/v1/projects/{id}/members', 'ProjectController@members');
...
Router::get('/v1/tasks/project/{projectId}', 'TaskController@project', ['AuthMiddleware', 'ProjectOwnerRights']);
